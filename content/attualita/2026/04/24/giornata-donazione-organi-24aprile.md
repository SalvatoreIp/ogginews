...
tags: ["donazione organi", "sanità", "trapianti", "Italia", "AIDO", "Salute"]
cover:
  image: /immagini/giornata-donazione-organi-24aprile.jpg
  alt: "Giornata Nazionale Donazione Organi"
---
...
1. **Chi non ha espresso opposizione** è considerato donatore
2. **La famiglia deve essere consultata** prima dell'intervento
3. **I dati sono registrabili** al Registro Nazionale Donatori
4. **L'opposizione può essere ritirata** in qualsiasi momento
...
1. **Registrarsi al Registro Nazionale Donatori:**
   - Sito: [www.medicinaevita.it](https://www.medicinaevita.it)
   - Costo: Gratuito
   - Validità: Illimitata

2. **Comunicare alla famiglia:**
   - Parlare con parenti stretti
   - Spiegare le proprie volontà
   - Evitare incomprensioni in momento di crisi

3. **Cartolina donatore:**
   - Ritirabile in ASL
...
### **Nuovi progetti:**
1. **Centro Nazionale Trapianti 2.0**: Potenziamento con tecnologie AI per la compatibilità
2. **Campagna "Salvare Vite 2026"**: 50 milioni di euro per sensibilizzazione
3. **Rete Donatori 24/7**: Servizio nazionale attivo 24 ore su 24
4. **App Donazione**: Piattaforma digitale per registrazione e gestione
...
- **Telefono**: 06 5994.1
- **Email**: direzione.trapianti@salute.gov.it

### **Centro Nazionale Trapianti:**
- **Sede**: Roma
- **Telefono**: 06 4990.4342
- **Email**: cnt@ministry.gov.it
...
1. ✅ **Registrati** al Registro Nazionale Donatori
2. ✅ **Parlane** con la tua famiglia
3. ✅ **Diffondi** informazioni corrette

**Donare organi significa donare vita. Donare speranza. Donare futuro.**

*Fonti: [Ministero della Salute](https://www.salute.gov.it/), [AIDO](https://aido.it/), [ISTAT](https://www.istat.it/), [Ospedale San Raffaele](https://www.hsr.it/), [FIDAL](https://www.fidal.it/)*
